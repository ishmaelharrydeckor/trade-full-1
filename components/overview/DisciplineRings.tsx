...
export default function DisciplineRings({
  ...
  return (
    <div 
      className="flex flex-col items-center justify-between rounded-2xl border p-5 bg-[#0f1318]/60 backdrop-blur-md h-full"
    ...
    >
      <div className="flex w-full items-center justify-between">
        ...
        <InfoTooltip text="Concentric rings tracking your process. Outer (Blue) = Rule compliance score. Middle (Green) = Emotion reflection frequency. Inner (Purple) = Streak consistency relative to a 7-day target." />
      </div>

      {/* SVG Concentrate Rings */}
