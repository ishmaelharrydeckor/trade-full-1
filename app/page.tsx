      ...
      <header className="sticky top-0 z-50 border-b backdrop-blur-md" style={{ borderColor: 'var(--border-panel)', backgroundColor: 'var(--nav-bg)' }}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-12">
          ...
          <nav className="flex items-center gap-4 text-sm font-medium">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center gap-1.5 rounded-xl px-4 py-2 font-semibold text-white shadow-lg shadow-indigo-500/25 transition hover:shadow-indigo-500/40"
              style={{
